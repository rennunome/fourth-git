...
public class QAEditController {
	...
	public String displayEditConfirm(@ModelAttribute("questions_id") int questions_id, @ModelAttribute("id") int cas_id, @ModelAttribute("question") String question, @ModelAttribute("answer") String answer, Model model , QuestionRequest questionRequest, CARequest caRequest) {
